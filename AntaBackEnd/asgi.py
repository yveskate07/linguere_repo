...
application = ProtocolTypeRouter(
    {
        ...
        "websocket": AllowedHostsOriginValidator(
            SessionMiddlewareStack(AuthMiddlewareStack(URLRouter(formations_websocket_urlpatterns + services_websocket_urlpatterns + users_websocket_urlpatterns + shop_websocket_urlpatterns)))
        ),
    }
)