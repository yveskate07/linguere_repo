...
def get_msg_for_client_mail(Service_name ,obj, width, height, quantite, comment, msg_deliver, colors=None):
    ...
    colors_html = ""
    if colors:
        colors_html = ' '.join(["""<div class="red-circle"></div>""" for i in colors])
...
def get_msg_for_admin_mail(**kwargs):
...
<body>
    <div class="email-container">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="http://---" class="button">Voir la commande</a>
        </div>
...
def save_broderie_order(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg_body1 = get_msg_for_client_mail('Broderie', 
                                               request.POST.get('support_type'),
                                               request.POST.get('dim_1'),
                                               request.POST.get('dim_2'),
                                               request.POST.get('quantity'),
                                               request.POST.get('codeCouleur').split(','),
                                               request.POST.get('special_instructions'),
                                               msg_deliver)
            
            msg_body2 = get_msg_for_admin_mail(service="Broderie Numérique",obj=request.POST.get('support_type'),
            ...
            mail_to_the_client(user={'e-mail': request.POST.get('email')}, html_msg=msg_body1,
                               subject="Confirmation de réception de votre commande")
            
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Broderie Numérique", )
...
def save_fraiseuse_order(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg_body1 = get_msg_for_client_mail('Fraiseuse',
            ...
            msg_body2 = get_msg_for_admin_mail(service="Fraiseuse Numérique", obj=request.POST.get('service_type'),
                                               width=request.POST.get('dim_1'),
                                               height=request.POST.get('dim_2'),
                                               quantity=request.POST.get('quantity'),
                                               comment=request.POST.get('special_instructions'),
            ...
            mail_to_the_client(user={'e-mail': request.POST.get('email')}, html_msg=msg_body1,
                               subject="Confirmation de réception de votre commande")
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Fraiseuse Numérique", )
            return HttpResponse("Felicitations votre commande a été enregistrée ")
...
def save_laser_order(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg_body1 = get_msg_for_client_mail('Découpe Laser',
                                               request.POST.get('service_type'),
                                               request.POST.get('dim_1'),
                                               request.POST.get('dim_2'),
                                               request.POST.get('quantity'),
            ...
            msg_body2 = get_msg_for_admin_mail(service="Découpe Laser", obj=request.POST.get('service_type'),
                                               width=request.POST.get('dim_1'),
                                               height=request.POST.get('dim_2'),
                                               quantity=request.POST.get('quantity'),
                                               comment=request.POST.get('special_instructions'),
            ...
            mail_to_the_client(user={'e-mail': request.POST.get('email')}, msg_txt=msg_body1,
                               subject="Confirmation de réception de votre commande")
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Découpe Laser", )
            return HttpResponse("Felicitations votre commande a été enregistrée ")
...
def save_imp_3d_order(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg_body1 = get_msg_for_client_mail('Impression 3D',
                                               request.POST.get('impression_type'),
                                               request.POST.get('dim_1'),
                                               request.POST.get('dim_2'),
                                               request.POST.get('quantity'),
                                               request.POST.get('codeCouleur').split(','),
            ...
            msg_body2 = get_msg_for_admin_mail(service="Impression 3D", obj=request.POST.get('impression_type'),
                                               width=request.POST.get('dim_1'),
                                               height=request.POST.get('dim_2'),
                                               quantity=request.POST.get('quantity'),
                                               comment=request.POST.get('special_instructions'),
            ...
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Impression 3D", )
...
def save_imp_text_order(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            msg_body2 = get_msg_for_admin_mail(service='Impression Textile',
                                               obj=request.POST.get('service_type'),
                                               width=request.POST.get('dim_1'),
                                               height=request.POST.get('dim_2'),
                                               quantite=request.POST.get('quantity'),
            ...
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Impression Textile", )
...
def save_imp_paper_order(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            msg_body2 = get_msg_for_admin_mail(service='Impression Papier',
                                               obj=request.POST.get('service_type'),
                                               width=request.POST.get('dim_1'),
                                               height=request.POST.get('dim_2'),
                                               quantite=request.POST.get('quantity'),
            ...
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Impression Papier", )
...
def save_imp_object_order(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            msg_body2 = get_msg_for_admin_mail(service='Impression Objets',
                                               obj=request.POST.get('service_type'),
                                               width=request.POST.get('dim_1'),
                                               height=request.POST.get('dim_2'),
                                               quantite=request.POST.get('quantity'),
            ...
            mail_to_fablab(user={'e-mail': request.POST.get('email')}, html_msg=msg_body2, subject="Nouvelle commande enregistrée pour Impression Objets", )
