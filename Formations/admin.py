...
class FormationAdmin(admin.ModelAdmin):
    ...
    fields = ('name', 'name_in_formation_page', 'duration', 'price', 'brochure', 'image','availability','hours_per_week','image_home','why_image',)
    ...
    def get_fields(self, request, obj=None): # Utilisez None par défaut, pas ...
        ...
        if obj and request.user.groups.filter(name='Developpers').exists():
            return ('name', 'name_in_formation_page', 'duration', 'price', 'brochure', 'image','availability','hours_per_week','image_home','why_image','slug','css_cls_parent_in_home','css_ps_cls_in_home', 'data_aos', 'data_aos_duration')
