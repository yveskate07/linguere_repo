...
class FormationAdmin(admin.ModelAdmin):
    ...
    def get_fields(self, request, obj=None): # Utilisez None par défaut, pas ...
        ...
        if obj and request.user.is_superuser:
            return ('name','duration', 'price','image','availability','hours_per_week','image_home','why_image','slug','css_cls_parent_in_home','css_ps_cls_in_home','css_style', 'data_aos', 'data_aos_duration')
